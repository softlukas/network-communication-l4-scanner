...
namespace proj1
{
    class ArgsOptions
    {
        ...
        [Option('u', "udp-ports", Required = false, HelpText = "UDP ports to scan (e.g., 53,67 or 1-65535).")]
        public string? UdpPorts { get; set; }

        [Option('t', "tcp-ports", Required = false, HelpText = "TCP ports to scan (e.g., 22,23,24 or 1-65535).")]
